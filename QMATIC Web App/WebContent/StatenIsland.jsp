...
<body>
	...
	<div class="row">
			<div class="col-md-12">
				<div class="page-header">
					<h2 align="center">
						<span><img align="left"
							 src="img/blank.gif">Detailed Wait Times - Staten Island Borough Office<img align="right"
	...
	<%
		List<Queue> qs = (List<Queue>) (new QueuesDao("1")).read("1");;
	%>
	...
	<div class="time">
		...
		<center>
			<form name="refresh" method="post" action="StatenIsland.jsp">
